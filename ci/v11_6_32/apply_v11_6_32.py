...
EXPECTED = "version: 11.6.31+191"
TARGET = "version: 11.6.32+192"

pubspec = Path("pubspec.yaml")
pub = pubspec.read_text()
if EXPECTED not in pub:
    raise SystemExit("V11.6.32: base version mismatch")
pubspec.write_text(pub.replace(EXPECTED, TARGET, 1))

audit = Path("lib/screens/audit_screen.dart")
audit.write_text(r"""import 'package:flutter/material.dart';
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (subject.isNotEmpty) const SizedBox(height: 6),
                _AuditDetailRow(
...
print("GardeFlow V11.6.32: journal administratif lisible et codes techniques masqués")
